...
// Yes, exactly. When you call an async function directly in the context of an Express.js route handler, you do not need to use .then and .catch to handle the promise returned by the async function. Express is designed to handle this for you.
